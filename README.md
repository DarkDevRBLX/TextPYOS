...
- It allows the community to work together on updates.
- It allows for the main versions to be more secure, as the main branch will only have trusted contributors.
- It allows the community to impliment features of their own.

### Please be aware that, the community code may not be fully up to standard, and may have vulnerabilities such as:

- Bugs
- Backdoors
- Malware

We check the code before it is merged, and encourage you to look at the code if it is a problem.
